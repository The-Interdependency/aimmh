...
- **License:** dual — **AGPL-3.0-or-later** + commercial (see `LICENSE`, `LICENSE-COMMERCIAL.md`). NOTE: `LICENSE` currently holds an interim notice; the full AGPL text has not yet been pasted in.
...
- **License is AGPL-3.0-or-later + commercial**, not Apache-2.0. Keep license claims consistent across files when editing docs.
